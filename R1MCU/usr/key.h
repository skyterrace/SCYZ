...
#define KEY_DOWN GPIOB,GPIO_Pin_8
#define KEY_LEFT GPIOC,GPIO_Pin_11
#define KEY_RIGHT GPIOB,GPIO_Pin_9
#define KEY_SET GPIOC,GPIO_Pin_12
#define KEY_OK GPIOB,GPIO_Pin_0
#define KEY_STOP GPIOC,GPIO_Pin_10
